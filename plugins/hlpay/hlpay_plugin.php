...
class hlpay_plugin
{
	...
	static public function alipay(){
		try{
			$result = self::addOrder('onAlipayQr');
	...
	static public function wxpay(){
		try{
			$result = self::addOrder('onWechatQr');
			$code_url = $result['pay_info'];
		}catch(Exception $ex){
	...
	static public function wxjspay(){
		...
		//②、统一下单
		try{
			$result = self::addOrder('offWechatPub', $wxinfo['appid'], $openid);
		}catch(Exception $ex){
			return ['type'=>'error','msg'=>'微信支付下单失败！'.$ex->getMessage()];
		}
	...
	static public function wxminipay(){
		...
		//②、统一下单
		try{
			$result = self::addOrder('offWechatLite', $wxinfo['appid'], $openid);
		}catch(Exception $ex){
	...
	static public function bank(){
		try{
			$code_url = self::addOrder('onUnionQr');
		}catch(Exception $ex){
	...
	static public function refund($order){
		...
		$param = [
			...
			'mch_refund_no' => 'REF'.$order['trade_no'],
